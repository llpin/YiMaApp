...
import com.templateapplication.adapter.ProductAdapter;
...
public class ProductRecycleVViewLayout extends LinearLayout {

    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager recyclerViewLayoutManager;
    private List<Drawable> drawableList = new ArrayList<>();

    public ProductRecycleVViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.product_recycle_v_view_layout,this);
        initForm();
    }
    ...
    public void initForm(){
        ...
        ProductAdapter adapter = new ProductAdapter(drawableList);
